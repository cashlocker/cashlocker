...
const QString BITCOIN_IPC_PREFIX("cashlocker:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click cashlocker: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start cashlocker: click-to-pay handler");
    else
...
{
    // clicking on cashlocker: URLs creates FileOpen events on the Mac:
